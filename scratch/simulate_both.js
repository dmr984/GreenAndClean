...
for (let day = 1; day <= 30; day++) {
    const todayStr = `2026-06-${String(day).padStart(2, '0')}T12:00:00`;
    ...
    const eomHrs = eomResult.monthlySummary.ordinaryHours;
    const eomDays = eomResult.monthlySummary.ordinaryWorkedDays;
    const shHrs = shiftsResult.monthlySummary.ordinaryHours;
    const shDays = shiftsResult.monthlySummary.ordinaryWorkedDays;

    console.log(`Day ${day} | EOM: ${eomHrs}h (${eomDays}gg) | Shifts: ${shHrs}h (${shDays}gg)`);
